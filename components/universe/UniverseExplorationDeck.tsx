            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 sm:text-base" style={{ color: 'var(--ink)' }}>
                  This is a productized “mission control” layer inspired by scientific exploration interfaces, adapted to Driftverse data instead of copying NASA’s UI. The center canvas is the spatial story. The panels are operational context.
                </p>
              </div>
